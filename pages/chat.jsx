...
/* const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTY0MzgwMTcwMCwiZXhwIjoxOTU5Mzc3NzAwfQ.Hs00UPBicDk6GU8AgX0QuG84TkQZSuGAElFxFFJAFPY'
const SUPABASE_URL = 'https://alljksmnszqsblxqfjqp.supabase.co'; */
  ...
  return (
    <Box
      styleSheet={{
        ...
        backgroundImage:
          "url(https://preview.redd.it/rau8ofogtd661.jpg?width=960&crop=smart&auto=webp&s=3ff87b5746799f6c2012a6c804bd7a3735d9ada8)",
  ...
  return (
    <Box
      ...
      styleSheet={{
        ...
        marginBottom: "16px",
        backgroundImage:
          "url(https://i.pinimg.com/736x/e0/a6/3d/e0a63d1790d21bc3c3a62ed3073d79e0.jpg)",
        backgroundRepeat: "no-repeat",
        backgroundSize: "cover",
        backgroundBlendMode: "multiply",
      }}
